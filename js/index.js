...
document.getElementById("btnTinhTien").onclick = function () {
  ...
  if (soKm <= 1) {
    ...
    tongTien = tienKmDauTienThanhTien + tienKmTu1Den19ThanhTien + tienKmTu19TroLenThanhTien;
  }
        ...
        <table class="table table-bordered" style="border-collapse: collapse;">
          ...
          <tbody>
            <tr>
              ...
              <td style="text-align:right;">${tienKmDauTien.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
              <td style="text-align:right;">${tienKmDauTienThanhTien.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
            </tr>
            <tr>
              <td>Từ 1 đến 19km</td>
              <td style="text-align:center;">${soKm > 1 ? soKm - 1 : 0}</td>
              <td style="text-align:right;">${tienKmTu1Den19.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
              <td style="text-align:right;">${tienKmTu1Den19ThanhTien.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
            </tr>
            <tr>
              <td>Từ 19km trở lên</td>
              <td style="text-align:center;">${soKm > 19 ? soKm - 19 : 0}</td>
              <td style="text-align:right;">${tienKmTu19TroLen.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
              <td style="text-align:right;">${tienKmTu19TroLenThanhTien.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
            </tr>
            <tr>
              <td>Thời gian chờ trên 3 phút</td>
              <td style="text-align:center;">${Math.floor((thoiGianCho - 3) / 3)}</td>
              <td style="text-align:right;">${tienThoiGianCho.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
              <td style="text-align:right;">${tongTienThoiGianCho.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
            </tr>
            <tr style="background-color: #f5f5f5; font-weight: bold;">
              <td colspan="3" style="font-size: 20px; text-align: left;">Tổng tiền</td>
              <td style="font-size: 20px; text-align: center;">${tongTien.toLocaleString("vi", { currency: "VND", style: "currency" })}</td>
            </tr>
          </tbody>
        </table>
        <div>
          <h4 style="text-align: center;">Cảm ơn quý khách đã ủng hộ</h4>
        </div>
      </div>
    </div>`;
